...
const OFFER_TYPES = {
  1: {
    title: "10% Reducere",
    description: "Se aplică la nota finală.",
    emoji: "🏷️",
    price: 300,
  },
  2: {
    title: "O cafea gratis",
    description: "Primiți un Espresso la desert.",
    emoji: "☕",
    price: 500,
  },
  3: {
    title: "1+1 Gratis",
    description: "Valabil la cocktail-uri.",
    emoji: "🍹",
    price: 600,
  },
  4: {
    title: "Desert Cadou",
    description: "La comenzi peste 40 RON.",
    emoji: "🍰",
    price: 800,
  },
};
  ...
  const handleActivateOffer = async (offerId) => {
    ...
    if (userPoints >= offerPrice) {
      ...
      Alert.alert(
        "Puncte insuficiente",
        `Ai nevoie de încă ${
          offerPrice - userPoints
        } puncte pentru a activa această ofertă.`
      );
    }
  };
    ...
    <>
      ...
      >
        <View style={styles.modalContainer}>
          ...
          <View
            style={[
              styles.offersModalContent,
              { backgroundColor: colors.card },
            ]}
          >
            <View style={styles.offersHeader}>
              <View>
                <Text style={[styles.offersTitle, { color: colors.primary }]}>
                  Oferte Disponibile
                </Text>
              ...
              {location?.offers && location.offers.length > 0 ? (
                location.offers.map((offerId, index) => {
                  ...
                  return (
                    ...
                    >
                      <View style={styles.offerEmojiContainer}>
                        <Text style={styles.offerEmoji}>{offerData.emoji}</Text>
                      </View>
